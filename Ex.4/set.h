 ...
 *
 * Contents:
 *        This file contains the interface of a Generic Set ADT module.
 *
 * Defined Types :
 ...
 *
 *        setGetFirst    - returns some representative element of the set -
 ...
 *    The order of traversing the set is undefined.
